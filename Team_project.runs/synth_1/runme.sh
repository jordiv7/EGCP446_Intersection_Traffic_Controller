...
HD_PWD='G:/Documents/Homework/EGCP 446/Team_project/Team_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSMStreetLight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSMStreetLight.tcl
