...
HD_PWD='G:/Documents/Homework/EGCP 446/Team_project/Team_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSMStreetLight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSMStreetLight.tcl -notrace
